...
import { CommentBox, CommentInput, CommentSubmitBtn, MyProfileOnComment, ProfileImgBox } from '../components/comment/commentInput/index.style';
            ...
            <ChatMainRoomBox>
                <div className='chat-cont'>
                    ...
                    <div className='message-cont'>
                        <p className='message-txt'>React의 개념과 장점, 그리고 컴포넌트란 무엇인가요?</p>
                    </div>
                ...
                <div className='chat-cont'>
                    <img className='profile-img' src={ProfileImg} alt="프로필 이미지" />
                    <div className='message-cont'>
                        <p className='message-txt'>리액트의 내부 작동 원리를 재조정 (Reconciliation) 개념과 함께 설명하세요.</p>
                    </div>
                ...
                <div className='chat-cont'>
                    <img className='profile-img' src={ProfileImg} alt="프로필 이미지" />
                    <div className='message-cont'>
                        <p className='message-txt'>옷리액트에 있는 라이프사이클과 각 라이프사이클의 역할을 설명하세요.</p>
                    </div>
