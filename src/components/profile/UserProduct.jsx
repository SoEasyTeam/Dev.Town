...
const ProductAreaList = ({ userProductData, alertOnModal, openModal }) => {
...
function UserProduct({token, accountname}) {
...
// const ProductAreaList = ({ productItem, alertOnModal }) => {

//     return (
//         <>
//             {productItem &&
//                 productItem.product.map((item) => {
//                     return (
//                         <div key={item.id} >
//                             <Product
//                                 name={item.itemName}
...
//     // const token = localStorage.getItem('token'); 
//     // const accountname = useSelector(state=>state.profile.accountname);

//     const productItem = useSelector(state=>state.product.products);

//     useEffect(() => {
//         dispatch(productAction.productList(token, accountname));
//     }, [])
...
//                         <h3 className='productAreaTitle'>판매 중인 상품</h3>
//                         <ProductAreaListUl>
//                             <ProductAreaList productItem={productItem} alertOnModal={alertOnModal} />
//                         </ProductAreaListUl>
//                     </div>
//                 </ProductArea>
//                 {alertOn === true ? <AlertProductModal alertOffModal={alertOffModal} /> : ''}
